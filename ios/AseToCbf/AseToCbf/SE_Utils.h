...
extern size_t SE_GetFileSize(FILE* fp);
/** user need to free the data of this function return */
extern void SE_ReadFileAll(FILE* fp, char** outData, size_t* outLen);
extern void SE_ReadFileAllByName(const char* name, char** outData, size_t* outLen);
/**
