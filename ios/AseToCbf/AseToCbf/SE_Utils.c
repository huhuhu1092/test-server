...
static void readFile(char* out, size_t fileSize, FILE* fp)
{
...
void SE_ReadFileAll(FILE* fp, char** outData, size_t* outLen)
{
    size_t fileSize = SE_GetFileSize(fp);
    *outData = NULL;
    *outLen = 0;
...
void SE_ReadFileAllByName(const char* name, char** outData, size_t* outLen)
{
