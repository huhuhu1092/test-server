...
enum SE_XMLTABLE_TYPE {SE_INVALID_TABLE, SE_ELEMENT_TABLE, SE_IMAGE_TABLE, SE_ACTION_TABLE, SE_STATE_TABLE, SE_COLOREFFECT_TABLE,
                       SE_SEQUENCE_TABLE, SE_TABLE_TYPE_NUM};
