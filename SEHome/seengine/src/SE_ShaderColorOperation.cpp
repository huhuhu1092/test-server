...
SE_ShaderColorOperation::SE_ShaderColorOperation()
{
...
void SE_ShaderColorOperation::getTextureModeColorOp(int* hasTexture, int num, int& outTexMode, int& outColorOp)
{
