...
(defun parse-image-table (file-name)
  ...
  (push *currimageitem* (imagetable-imageitems *currimagetable*))
  (push *currimagetable* *imagetablelist*)
...
(defun process-attribute (element-head attr-list)
  ...
  (cond ((is-imagetable element-head)
	 (let ((instance (parse-attribute attr-list :imagetable)))
	   (if instance (progn (push *currimagetable* *imagetablelist*) (setf *imagetablelist* (nreverse *imagetablelist)) (setf *currimagetable* instance)))
	   )
	 )
	((is-imageitem element-head)
	 (let ((instance (parse-attribute attr-list :imageitem)))
	   (if instance (progn (push *currimageitem* (imagetable-imageitems *currimagetable*)) (setf *currimageitem* instance)))
	   )
	 )
