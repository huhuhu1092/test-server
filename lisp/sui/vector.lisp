...
(defmethod vector-sub ((v1 vector2f) (v2 vector2f))
  (vector-op 2 f v1 2 f v2 -)
  )
(defmethod vector-sub ((v1 vector2f) (v2 vector3f))
  (vector-op 2 f v1 3 f v2 -)
  )
(defmethod vector-sub ((v1 vector3f) (v2 vector2f))
  (vector-op 3 f v1 2 f v2 -)
  )
(defmethod vector-sub ((v1 vector2f) (v2 vector4f))
  (vector-op 2 f v1 4 f v2 -)
  )
(defmethod vector-sub ((v1 vector3f) (v2 vector4f))
  (vector-op 3 f v1 4 f v2 -)
  )
(defmethod vector-sub ((v1 vector3f) (v2 vector3f))
  (vector-op 3 f v1 3 f v2 -)
  )
(defmethod vector-sub ((v1 vector4f) (v2 vector4f))
  (vector-op 4 f v1 4 f v2 -)
  )
(defmethod vector-dot ((v1 vector2f) (v2 vector2f))
  (vector-op 2 f v1 2 f v2 *)
  )
(defmethod vector-dot ((v1 vector3f) (v2 vector3f))
  (vector-op 3 f v1 3 f v2 *)
  )
(defmethod vector-dot ((v1 vector4f) (v2 vector4f))
  (vector-op 4 f v1 4 f v2 *)
  )
(defun make-vector2f (x y)
  (make-instance 'vector2f :x x :y y)
  )
(defun make-vector3f (x y z)
  (make-instance 'vector3f :x y :y y :z z))
(defun make-vector4f (x y z w)
  (make-instance 'vector4f :x x :y y :z z :w w))
;;test case
