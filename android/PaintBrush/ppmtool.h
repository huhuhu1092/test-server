...
extern ppm_t resize_return (ppm_t *p, int nx, int ny);
extern void rescale(ppm_t *p, double sc);
extern ppm_t rescale_return(ppm_t *p, double sc);
...
extern ppm_t edgeDetection(ppm_t* srcImage, int start, int end);
