...
/////////////////////////////////////////////////////////////
class SE_UserObject : public SE_Primitive
{
public:
    SE_UserObject();
    SE_Spatial* create(SE_Scene* scene, SE_Spatial* parent);
    ~SE_UserObject();
    void setImageDataID(SE_ImageDataID& imageDataID, SE_OWN_TYPE own)
    {
    ...
    void setRendererID(const SE_RendererID& rendererID)
    {
    ...
    void setIfNeedBlending(bool needBlending)
    {
        mNeedBlending = needBlending;
    } 

    void setIfNeedDepthTest(bool needDepthTest)
    {
        mNeedDepthTest = needDepthTest;
    }
