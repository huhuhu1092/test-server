...
class SE_SimObject;
class SE_ObjectPhoneRingOnAnimation : public SE_Animation
{
public:
...
class SE_ObjectClockMoveAnimation : public SE_Animation
{
public:
...
class SE_ObjectCameraTranslateAnimation : public SE_Animation
{
public:
...
class SE_ObjectFadeInOutAnimation : public SE_Animation
{
public:
